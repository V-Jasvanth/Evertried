...
const CoordinatorDashboard = () => {
    ...
    const fetchDashboard = useCallback(async () => {
        ...
        try {
            ...
            const res = await axios.get(
                `${API_URL}/api/dashboard/coordinator`,
                config
            );
    ...
    useEffect(() => {
        ...
        // Delay the first fetch to avoid synchronous
        // state updates inside the effect.
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 w-full">
            ...
            <div className="mb-10">
                <h1 className="text-3xl font-black text-slate-900 tracking-tight flex items-center gap-3">
                    <Activity className="w-8 h-8 text-brand-DEFAULT" />
                    Coordinator Command Center
                </h1>

                <p className="text-slate-500 mt-2 text-lg">
                    System-wide assignment tracking and job monitoring.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-3xl font-black text-slate-800">
                            {data.stats.totalActiveAssignments || 0}
                        </p>
                    </div>
                </div>
                ...
                <div className="bg-slate-900 p-6 rounded-2xl border border-slate-800 shadow-xl flex items-center gap-4 text-white">
                    ...
                    <div>
                        ...
                        <p className="text-3xl font-black text-brand-light">
                            {data.stats.systemHealth || 'Booting...'}
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex justify-between items-start mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-500 font-medium">
                                            Employer:{' '}
                                            {job.employer?.name || 'Local Company'}
                                            {' • '}
                                            {job.location &&
                                ...
                                <div className="w-full bg-slate-100 rounded-full h-3 mb-6">
                                    <div
                                        className="bg-brand-DEFAULT h-3 rounded-full transition-all duration-1000"
                                        style={{
                                            width: `${progress}%`
                                        }}
                                    />
                                ...
                                <div className="flex flex-wrap gap-2">
                                    ...
                                    {job.applicants
                                        ...
                                        .map((applicant, i) => (
                                            ...
                                            <div
                                                key={i}
                                                className="flex items-center gap-1.5 bg-green-50 text-green-700 px-3 py-1.5 rounded-lg border border-green-200 text-xs font-bold"
                                            >
